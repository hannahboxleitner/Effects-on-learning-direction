...
that also shows the model's residuals. Residuals are the difference between
the model’s predicted value and the real, observed value of the outcome
variable.
For this task, I want to use the
...
The solid lines represent the regression lines of the model, for
