...
# In this chunk, we want to create a table that summarizes results of descriptive statistics, similar to the Table 4 in the paper (p. 1126). As with the target items, there was no code available for creating the tables. But with the available data, we can find a way to reproduce them anyway!
...
Now we have a table that summarizes the descriptive statistics of the
