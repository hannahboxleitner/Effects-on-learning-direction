...
Generally, @2021 used base `R` plots in their original code. While there is nothing wrong with that, one could also use {gglpot2}, which provides many options to add layers, extend the plot, alter the appearance of the plot etc.
