...
```
In the next step, we want to scale the continuous predictor. This converts the vocabulary scores to have a mean of 0 and standard deviation of 1 which is helpful for interpretation!
