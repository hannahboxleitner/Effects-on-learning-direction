...
Now, before creating our histograms, we will add some kind of tiny helper for style. It will also keep our histograms consistent. The commands 'fill_blue' and 'line_blue' store the colors we want that we will use for all following histograms. 'base_theme' here creates a clean appearance by removing any unnecessary gridlines and then setting a readable font size (12).
