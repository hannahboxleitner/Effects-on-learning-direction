...
To extend the work on this model, I want to plot the results in a way that also shows the model's residuals. As you can read in **Chapter 13.4** of this book, model residuals are calculated by subtracting a model’s prediction from the real, observed value of the outcome variable for any specific data point.
