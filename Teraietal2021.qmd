...
kable(var_info, caption = "Description of Dataset Variables") %>%
...
both Test2 and Condition2 are present, which is, when participants take the L2 production test after learning in the L2 -> L1 direction, the accuracy is even lower than
