...
*Interpretation: Without the interaction, the model assumes that the
effects of Test and Condition are additive and do not depend on each
other. AIC (Akike Information Criterion) is udes to compare models,
lower is better.*
...
Interpretation: The anova function() tests whether the interaction
