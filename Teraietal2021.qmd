...
Standardizing our variables is an important step for as since it is very useful when variables are measured on different scales or when you want to compare them in a fair way. Also, there are some statistical mdels that work better when predictors are standardized. 
...
Lastly, we want to display the results in a clean, formatted table similarly to the authors, for
