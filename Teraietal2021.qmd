...
The following code chunk shows how Terai et al. fit the model without interaction. Subsequently, the authors calculated AIC (Akike Information Criterion) for their model. We will explain more about this criterion later.
