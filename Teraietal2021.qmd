...
intervals for both learning directions, which means we can be 95%
confident that the true standardized effect size lies in this range
(which is a meaningful effect size, in our case).
