...
The same procedure is now applied in the other direction: While with variable `a`, `emmeans()` was told to do pairwise comparisons of Condition levels within each level of Test, @2021 also computed all comparisons of Test levels within each level of Condition, and saved this object as the variable `b`.
