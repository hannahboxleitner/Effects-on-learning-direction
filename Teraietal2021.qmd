...
To calculate Cronbach's alpha, @2021 used the `alpha()` function und vocabulary scores, of both L1 and L2 production sets. Here, we will only show the code and output reliability analysis for Vocabulary A scores of the L1 production dataset, as an example.
